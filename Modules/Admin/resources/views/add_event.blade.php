...
<h4 class="py-3 mb-4">
<span class="text-muted fw-light">Dashboard /</span> Add Event
</h4>
        ...
        <div class="card mb-4">
          ...
          <div class="card-body">
            ...
            <div class="col-md-4 mb-3">
                ...
                <input class="form-control" type="time" name="start_time" id="html5-time-input">
            ...
            <div class="col-md-4 mb-3">
                ...
                <input class="form-control" type="time" name="end_time" id="html5-time-input">
