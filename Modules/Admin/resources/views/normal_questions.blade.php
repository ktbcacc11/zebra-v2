...
<h4 class="py-3 mb-4">
<span class="text-muted fw-light">Dashboard /</span> Normal Questions
</h4>

<!-- Card Border Shadow -->
<div class="row">
    <div class="card">
        <h5 class="card-header">Normal Questions</h5>
          ...
          <table class="dt-row-grouping table border-top data-table" style="width:100%">
            ...
            <td>
                <div class="demo-inline-spacing" >
                    <a href="{{ url('admin/edit-normal-question/'.$question->id.'') }}" ><button type="button" class="btn btn-primary btn-xs">Edit</button></a>
