...
<h4 class="py-3 mb-4">
<span class="text-muted fw-light">Dashboard /</span> Add Video Tips
</h4>

<!-- Card Border Shadow -->
<div class="row">
        <div class="card mb-4">
          <h5 class="card-header">Add Video Tips</h5>
          ...
          <div class="card-body">
            ...
            <div class="col-md-4 mb-3">
              ...
              <input type="text" class="form-control" id="defaultFormControlInput" name="video" />
