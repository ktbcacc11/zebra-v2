...
<div class="container-fluid">
    <div class="main-wrapper">
        <div>
            ...
            <p class="page-description mb-0">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do</p>
            <div class="flex-row">
        ...
        <div class="col-lg-9 col-md-9 col-12 mt-4">
            ...
            <div>
                <h5 class="careers-sub-title">Your Main Reposnsibilities</h5>
                <ul class="careers-section-list">
                    <li>- Maintain an accurate record of all opportunities and engagements in Salesforce.</li>
                    <li>- Work with the marketing teams on both sides to put in place a partner-specific marketing plan to help drive demand in the region.</li>
                    <li>- Build strategic relationships within defined partners at all levels in their organizations to evangelize and build stickiness on technology</li>
                    <li>- Negotiate contracts and commercial business terms.</li>
                    <li>- Responsible for building a sales pipeline (qualified opportunities as captured in Salesforce) and monitoring deal closures as per forecasts and targets.</li>
                </ul>
            </div>


            <div>
                <h5 class="careers-sub-title">Qualifications and Skills</h5>
                <ul class="careers-section-list">
