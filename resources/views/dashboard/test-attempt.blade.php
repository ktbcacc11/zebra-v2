...
<div class="dashboard-page-content pb-5">
    <div class="p-3 w-100" style="padding-left: 40px !important;>
        ...
        <div class="row align-items-center">
            <div class="col-6">
                <p class="report-normal-text mt-4" style="padding-bottom: 35%;">
                Your brain is wired for innovation, creativity, and unconventional thinking. As an <strong>Innovative Maverick, Creative Visionary</strong>, or <strong>Non-Conformist Thinker</strong>, you thrive in environments that encourage original thought and exploration beyond traditional boundaries. Your approach to problem-solving is characterized by a willingness to take risks, think outside the box, and challenge the status quo.
                </p>
            </div>
             <div class="col-6 desktop-img-respon">
                 <img src="{{ asset('assets/images/phone.png') }}" class="side-img-desktop">
...
<div class="dashboard-page-content pb-5">
    <div class="p-3 w-100" style="padding-left: 40px !important;>
        ...
        <div class="row align-items-center">
            <div class="col-6">
                <p class="report-normal-text mt-4" style="padding-bottom: 35%;">
                    Your brain is characterized by a harmonious blend of analytical and practical thinking. As a <strong>Balanced Logical Thinker</strong> or <strong>Dual Analytical-Practical</strong>, you possess the ability to approach problems with both a logical framework and a practical mindset. This unique combination allows you to analyze situations thoroughly while also considering real-world applications and outcomes.
                </p>
            </div>
             <div class="col-6 desktop-img-respon">
                 <img src="{{ asset('assets/images/phone.png') }}" class="side-img-desktop">
...
<div class="dashboard-page-content pb-5">
    <div class="p-3 w-100" style="padding-left: 40px !important;>
        ...
        <div class="row align-items-center">
            <div class="col-6">
                <p class="report-normal-text mt-4" style="padding-bottom: 35%;">
                Your brain is characterized by a unique blend of relational and creative thinking. As a <strong>Relational Creative</strong> or <strong>Creative Connector</strong>, you possess the ability to form deep connections with others while also expressing your creativity in innovative ways. Your strengths lie in your capacity to understand emotions, foster relationships, and think outside the box to generate new ideas.
                </p>
...
<div class="dashboard-page-content pb-5">
    <div class="p-3 w-100" style="padding-left: 40px !important;>
        ...
        <div class="row align-items-center">
            <div class="col-6">
                <p class="report-normal-text mt-4" style="padding-bottom: 35%;">
                Your brain is characterized by a unique blend of logical analysis and creative problem-solving. As an <strong>Innovative Analyst</strong> or <strong>Creative Problem-Solver,</strong> you possess the ability to dissect complex issues while also thinking outside the box to generate innovative solutions. Your strengths lie in your analytical thinking, critical reasoning, and capacity to apply creativity in practical ways.
                </p>
